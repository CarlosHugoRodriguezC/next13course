  ...
  return (
    <div className="w-full h-screen flex flex-col items-center justify-center">
      ...
      <div className="flex flex-col items-center justify-center">
        ...
        <button
          className="bg-gray-900 text-white px-4 py-2 rounded-md mt-4 transition-all duration-300 ease-in-out hover:bg-transparent hover:text-gray-900 border border-gray-900 hover:border-gray-900"
          onClick={() => reset()}
        >
          Try again
        </button>
